        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background: #141313;">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <!-- Surat Keputusan -->
                    <li class="<?php if (strtolower($this->uri->segment(2)) == 'surat_keputusan') echo 'active' ?>"><a href="<?= base_url() . $dir . '/' ?>surat_keputusan">
                            <i class="fa fa-folder"></i> <span>Surat Keputusan</span>
                        </a>
                    </li>
                    <!-- End Surat Keputusan -->

                    <!-- Surat Lain -->
                    <li class="<?php if (strtolower($this->uri->segment(2)) == 'surat_lain') echo 'active' ?>"><a href="<?= base_url() . $dir . '/' ?>surat_lain">
                            <i class="fa fa-folder"></i> <span>Surat Lain</span>
                        </a>
                    </li>
                    <!-- End Surat lain -->
