...
class Surat_lain extends CI_Controller
{

    private $title = "Surat Lain";
    ...
    public function index()
    {
        ...
        $crud->set_table('surat_lain_mif');

        $crud->set_subject('Surat Lain');
        ...
        $crud->set_relation('id_kategori', 'kategori_lain', 'nama_kategori');
